    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6 md:px-12 bg-gradient-to-br from-indigo-50 to-white overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-42 items-center">
            <div className="text-center lg:text-left space-y-6">
              ...
              <div className="flex flex-col items-center lg:items-start space-y-2">
                <img src={p12 || "/placeholder.svg"} alt="Ari Afshar signature" className="h-16" />
      ...
      <section className="py-16 px-6 md:px-12 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="rounded-xl overflow-hidden shadow-lg mb-20">
            <div className="relative">
              <img src={p13 || "/placeholder.svg"} alt="Team meeting" className="w-full h-auto object-cover" />
          ...
          {/* An All Too Familiar Story section */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-86 items-center mb-20">
            ...
            <div className="rounded-xl overflow-hidden shadow-lg">
              <img src={p14 || "/placeholder.svg"} alt="Agent using Navigate" className="w-full h-auto object-cover" />
            </div>
          </div>

          {/* Your Pain, Our Purpose section */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-86 items-center">
            <div className="order-2 md:order-1 rounded-xl overflow-hidden shadow-lg">
              <img
                src={p15 || "/placeholder.svg"}
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col">
            ...
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">Get Your Prospecting Back on Track</h2>
